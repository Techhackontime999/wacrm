...
- [GitHub Security Advisories](https://github.com/Techhackontime999/wacrm/security/advisories/new)
...
In scope:
- Anything in this repository (`Techhackontime999/wacrm`), including webhook and auth
