...
```bash
# 1. Fork on GitHub: https://github.com/Techhackontime999/wacrm → Fork
# 2. Clone your fork
...
```bash
git remote add upstream https://github.com/Techhackontime999/wacrm.git  # once
git fetch upstream
git checkout main
...
[bug report](https://github.com/Techhackontime999/wacrm/issues/new?template=bug_report.yml)
...
- Rebrand. The "CRM Template for WhatsApp" name, favicon, and
  `crm-neural-aurora.vercel.app` URL belong to the upstream project; please swap them
